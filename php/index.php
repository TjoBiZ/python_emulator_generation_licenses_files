...
echo shell_exec('bash -c "bash command ./gen.py 121212 0022"');
echo system('./gen.py'.escapeshellarg('001212 0023'),$output);
echo exec('perl -e \'print `bash -c "bash command /Users/joker/Downloads/websites/python/php/./gen.py"`\'',$output, $return_var);
